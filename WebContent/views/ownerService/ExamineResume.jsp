				...
				<div class="divArea" style="vertical-align:bottom;" >
					...
					<div class='form-row'>
					  ...
					  <p class="rLabel" style="color:purple; font-style: bold;">
						  <%if(appliant.getPassOrFail().equals("UC")){%>사장님 확인전
							<%}else if(appliant.getPassOrFail().equals("C")){%>사장님 확인함
							<%}else if(appliant.getPassOrFail().equals("P")){%>합격
							<%}else if(appliant.getPassOrFail().equals("F")){%>탈락
							<%}%>
					  </p>
					</div>
