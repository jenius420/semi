		...
		<input type="checkbox">-->
			...
			<form id="joinForm" onsubmit="return joinValidate();" method="post" action="<%= request.getContextPath()%>/empInsert.me ">
				<table>
					...
					<tr>
						<td><b>아이디</b></td>
						<td><input name="id" id="id" type="text" size="28" maxlength="15" placeholder="4~15자 영문, 숫자(영문 소문자 시작)"></input></td>
					...
					<tr>
						<td><b>사업자등록번호</b></td>
						<td>
							<input id="oNum" name="oNum" type="text" size="28" maxlength="10" placeholder=" - 제외하고 숫자만 입력 해주세요"></input>
					...
					<tr>
						<td><b>대표자명</b></td>
						<td><input id="name" name="name" type="text" size="28" maxlength="5" placeholder="성명 입력"></input></td>
					...
					<tr>
						...
						<td>
							...
							<input type="tel" size="18" maxlength="8" placeholder="- 제외하고 입력 해주세요">
